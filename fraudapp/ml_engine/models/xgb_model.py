...
class XGBoostFraudClassifier:
    ...
    def __init__(
        ...
        self.model = xgb.XGBClassifier(
            ...
            scale_pos_weight=scale_pos_weight,  # 🔥 USE THIS
            tree_method="hist",
    ...
    def save(self, model_dir: Path):
        ...
        joblib.dump(self.model, model_dir / "xgb.joblib")

    def load(self, model_dir: Path):
        self.model = joblib.load(model_dir / "xgb.joblib")
        self.is_trained = True
