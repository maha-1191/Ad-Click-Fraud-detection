...
run_training.py
----------------
Entry point for FULL model training.

Pipeline:
CSV
 → Preprocess
 → Feature Engineering (14 features)
 → Sequence Builder (IP-based)
 → CNN + RNN (supervised)
 → Sequence Embeddings
 → (Optional) SMOTE
 → XGBoost
...
def main():
    ...
    logger.info("Saved xgboost_model.joblib")

    


    # --------------------------------------------------
    # 🔟 TRAIN & VALIDATION METRICS (threshold = 0.5)
    # --------------------------------------------------
